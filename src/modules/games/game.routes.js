...
import { getTrending, search, searchPage, getById, getBySlug, getNewReleases, getRandom, getPopularOnHitboxd, getRecommended, getExtras, getStats, triggerReindex, triggerRecomputeScores, refreshIgdb } from './game.controller.js';
...
router.post('/admin/refresh-igdb/:type', verifyToken, verifyAdmin, refreshIgdb);
